...
class StudentsController extends Controller
{
    ...
    public function store(StorePageRequest $request)
    {
        ...
        return new RedirectResponse(route('admin.students.index'), ['flash_success' => __('alerts.backend.pages.created')]);
    }
    ...
    public function update(Page $page, UpdatePageRequest $request)
    {
        ...
        return new RedirectResponse(route('admin.students.index'), ['flash_success' => __('alerts.backend.pages.updated')]);
    }
    ...
    public function destroy(Page $page, DeletePageRequest $request)
    {
        ...
        return new RedirectResponse(route('admin.students.index'), ['flash_success' => __('alerts.backend.pages.deleted')]);
    }
}
